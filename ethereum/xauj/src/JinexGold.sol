...
/// @title Jinex Gold (XAUJ)
/// @notice Single public Ethereum-side XAUJ token. Mint/burn is restricted to the configured reserve vault.
...
contract JinexGold {
    ...
    modifier onlyVault() { if (msg.sender != vaultMinter) revert NotVault(); _; }
