#!/usr/bin/env python3
"""HF123 regtest end-to-end test for embedded RPC and the reference miner.
...
TOKEN = "hf123-regtest-token-7f67b2dbdc714a58"
...
def main() -> int:
    ...
    temp_path = Path(tempfile.mkdtemp(prefix="qub-hf123-rpc-e2e-"))
    ...
    try:
        ...
        print(f"HF123 E2E directory: {temp_path}")
        ...
        print("HF123 RPC REGTEST E2E: PASS")
        return 0
    finally:
...
if __name__ == "__main__":
    try:
        ...
        print(f"HF123 RPC REGTEST E2E: FAIL: {exc}", file=sys.stderr)
        raise SystemExit(1)
